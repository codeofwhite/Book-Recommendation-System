...
class User(db.Model):
    ...
    avatar_url = db.Column(
        db.String(255),
        nullable=True,
        default="https://th.bing.com/th/id/OIP.cTPVthB0oT1RXrEcSHaaTwHaHa?w=191&h=191&c=7&r=0&o=7&dpr=1.3&pid=1.7&rm=3",
    )
    ...
    preferred_book_types = db.Column(
        db.Text, nullable=True
    )  # 例如 'fiction,non-fiction'
    preferred_authors = db.Column(
        db.Text, nullable=True
    )  # 例如 'J.K. Rowling,George R.R. Martin'
    preferred_genres = db.Column(db.Text, nullable=True)  # 例如 'mystery,thriller'
    preferred_reading_duration = db.Column(
...
class Admin(db.Model):
    ...
    password = db.Column(
        db.CHAR(64), nullable=False, comment="密码"
    )  # 存储哈希后的密码
